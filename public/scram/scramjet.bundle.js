var e,
	...
	i = {
		4322: function (e) {
				...
				return (
					l.forEach(function (e) {
						var t = e.split("="),
							...
							n = t.join("=");
						"expires" === r
							? (p.expires = new Date(n))
							: "max-age" === r
								? (p.maxAge = parseInt(n, 10))
								: "secure" === r
									? (p.secure = !0)
									: "httponly" === r
										? (p.httpOnly = !0)
			...
			function a(e, a) {
				...
				return (Array.isArray(e) || (e = [e]), a.map)
				...
				constructor(e) {
					...
					if (d.iswindow) {
						...
						this.box ||
							...
							(this.box = new p.SingletonBox(this)));
					...
					(this.box.registerClient(this, e),
						...
						(this.wrapfn = (0, i.createWrapFn)(this, e)),
						(this.natives = {
							store: new Proxy(
								{},
								{
									get: (e, t) => {
										...
										let r = t.split("."),
											n = r.pop(),
											a = r.reduce((e, t) => e?.[t], this.global);
										if (!a) return;
										let s = Reflect.get(a, n);
										return ((e[t] = s), e[t]);
									},
								}
							),
						...
						(s.construct = function (e, t, n) {
							let a,
								...
								i = {
									...
									call: () => (
										(s = !0),
										(a = Reflect.construct(i.fn, i.args, i.newTarget))
									),
								};
							return (r.construct(i), s)
								? a
								: Reflect.construct(i.fn, i.args, i.newTarget);
						}),
						r.apply &&
							(s.apply = (e, t, n) => {
								let a,
									...
									i = {
										...
										call: () => (
											(s = !0),
											(a = Reflect.apply(i.fn, i.this, i.args))
										),
									},
								...
								return ((Error.prepareStackTrace = o), s)
									? a
									: Reflect.apply(i.fn, i.this, i.args);
							}),
						(s.getOwnPropertyDescriptor = a.getOwnPropertyDescriptorHandler),
						(e[t] = new Proxy(n, s)));
				}
				Trap(e, t) {
					if (Array.isArray(e)) {
					...
					return ((this.descriptors.store[e] = s), this.RawTrap(a, n, t));
				}
				RawTrap(e, t, r) {
					if (!e || !t || !Reflect.has(e, t)) return;
					...
					return (
						r.get
							? (s.get = function () {
									return ((a.this = this), r.get(a));
								})
							: n?.get && (s.get = n.get),
						r.set
							? (s.set = function (e) {
									((a.this = this), r.set(a, e));
								})
							: n?.set && (s.set = n.set),
						r.enumerable
							...
							return new Proxy(r, {
								get(e, t) {
									...
									return "function" == typeof a
										...
										: t in CSSStyleDeclaration.prototype || !a
											? a
											: (0, n.f)(a);
								},
								set: (t, r, a) =>
									"cssText" == r || "" == a || "string" != typeof a
										? Reflect.set(t, r, a)
										: Reflect.set(t, r, (0, n.s)(a, e.meta)),
							});
						},
						set(e, t) {
							e.set(t);
				...
				(e.Trap("Node.prototype.baseURI", {
					...
					e.Proxy("Element.prototype.setAttribute", {
						apply(t) {
							...
							if (s) {
								let n = s.fn(a, e.meta, e.cookieStore);
								if (null == n) {
									(e.natives.call(
								...
								((t.args[1] = n),
									t.fn.call(t.this, `scramjet-attr-${t.args[0]}`, a));
							}
						},
					}),
					...
					e.Proxy("Element.prototype.setAttributeNS", {
						apply(t) {
							...
							i &&
								((t.args[2] = i.fn(s, e.meta, e.cookieStore)),
								e.natives.call(
					...
					e.Trap("Element.prototype.innerHTML", {
						set(r, n) {
							...
							if (r.this instanceof t.HTMLScriptElement)
								((o = (0, i.o)(n, "(anonymous script element)", e.meta)),
									e.natives.call(
										"Element.prototype.setAttribute",
										r.this,
								...
								try {
									o = (0, s.Qs)(n, e.cookieStore, e.meta);
								} catch {
									o = n;
								}
							r.set(o);
					...
					e.Trap("Node.prototype.textContent", {
						set(r, n) {
							if (r.this instanceof t.HTMLScriptElement) {
								let t = (0, i.o)(n, "(anonymous script element)", e.meta);
								return (
									e.natives.call(
										"Element.prototype.setAttribute",
										r.this,
					...
					e.Proxy("Text.prototype.appendData", {
						apply(t) {
							t.this.parentElement?.tagName === "STYLE" &&
								(t.args[0] = (0, a.s)(t.args[0], e.meta));
						},
					}),
					e.Proxy("Text.prototype.insertData", {
						apply(t) {
							t.this.parentElement?.tagName === "STYLE" &&
								(t.args[1] = (0, a.s)(t.args[1], e.meta));
						},
					}),
					e.Proxy("Text.prototype.replaceData", {
						apply(t) {
							t.this.parentElement?.tagName === "STYLE" &&
								(t.args[2] = (0, a.s)(t.args[2], e.meta));
						},
					}),
					...
					["History.prototype.pushState", "History.prototype.replaceState"],
					{
						apply(t) {
							...
							let {
								...
								i = r("return globalThis")(),
								o = i[s.pX];
							if (i.name === e.meta.topFrameName) {
								let t = new a.UrlChangeEvent(o.url.href);
			...
			function i(e) {
				(e.Proxy("window.open", {
					apply(t) {
						...
						if (a.pX in r) return t.return(r[a.pX].global);
						{
					...
					e.Trap("window.frameElement", {
						get(e) {
							let t = e.get();
							return t ? (t.ownerDocument.defaultView[a.pX] ? t : null) : t;
						},
					}));
			}
		},
		...
		6286: function (e, t, r) {
			...
			function s(e, t) {
				(e.Trap("PerformanceEntry.prototype.name", {
					get(e) {
						let t = e.get();
						return t && t.startsWith(location.origin + a.$W.prefix)
							? (0, n.v2)(t)
							: t;
					},
				}),
					e.Proxy(
						...
						],
						{
							apply(e) {
								...
								return e.return(
									t.filter((e) => {
										for (let t of Object.values(a.$W.files))
		...
		9201: function (e, t, r) {
			...
			var n = r(37),
				a = r(1472);
			let s = 2,
				i = (e) => (0, n.U5)("serviceworkers", e.url);
			function o(e, t) {
					...
					e.Proxy("ServiceWorkerContainer.prototype.register", {
						apply(t) {
							...
							(Object.setPrototypeOf(
								...
								(n.constructor = t.fn));
							let s = (0, a.Oy)(t.args[0], e.meta) + "?dest=serviceworker";
							t.args[1] && "module" === t.args[1].type && (s += "&type=module");
							let i = e.natives.construct("SharedWorker", s).port,
								o = { scope: t.args[0], active: i },
								l = e.descriptors.get(
									"ServiceWorkerContainer.prototype.controller",
									e.serviceWorker
								);
		...
		1323: function (e, t, r) {
			...
			function g(e) {
				if (
					...
					let r = new i.ScramjetContextEvent(e.global.window, e);
					e.frame?.dispatchEvent(r);
					let a = new i.UrlChangeEvent(e.url.href);
		...
		3255: function (e, t, r) {
			(r.r(t),
				r.d(t, {
					...
					isemulatedsw: () => a.isemulatedsw,
					isshared: () => a.isshared,
					issw: () => a.issw,
					iswindow: () => a.iswindow,
					isworker: () => a.isworker,
					loadAndHook: () => a.loadAndHook,
				}));
			var n = r(336),
				a = r(1323),
				s = r(1862),
		...
		3696: function (e, t, r) {
			...
			function i(e, t) {
				...
				let o = s.iswindow ? t.location : r.prototype;
				for (let r of [
					"protocol",
					"hash",
					"host",
					...
					let a = e.natives.call("Object.getOwnPropertyDescriptor", null, o, r);
					if (!a) continue;
					let s = { configurable: !1, enumerable: !0 };
					(a.get && (s.get = new Proxy(a.get, { apply: () => e.url[r] })),
						a.set &&
							(s.set = new Proxy(a.set, {
								apply(a, s, i) {
									if ("href" === r) {
										e.url = i[0];
										return;
				...
				return (
					...
					t.location.assign &&
						(i.assign = new Proxy(t.location.assign, {
							apply(r, s, i) {
								((i[0] = (0, a.Oy)(i[0], e.meta)),
									Reflect.apply(r, t.location, i));
		...
		6627: function (e, t, r) {
			...
			function a(e, t) {
				let r = (e) => {
					let r = e.split("."),
						n = r.pop(),
						a = r.reduce((e, t) => e?.[t], t);
					a && n && n in a && delete a[n];
				};
				(r("BarcodeDetector"),
					r("FaceDetector"),
					r("TextDetector"),
		...
		582: function (e, t, r) {
			(r.r(t), r.d(t, { argdbg: () => s, default: () => i, enabled: () => a }));
			var n = r(37);
			let a = (e) => (0, n.U5)("captureErrors", e.url);
			function s(e, t = []) {
				switch (typeof e) {
					case "string":
						break;
		...
		591: function (e, t, r) {
			(r.r(t), r.d(t, { default: () => s, indirectEval: () => i }));
			var n = r(37),
				a = r(1478);
			function s(e, t) {
				Object.defineProperty(t, n.$W.globals.rewritefn, {
					value: function (t) {
						return "string" != typeof t
							? t
							: (0, a.o)(t, "(direct eval proxy)", e.meta);
					},
					writable: !1,
					configurable: !1,
				});
		...
		`)))
							: (r = this.global.eval),
						r((0, a.o)(t, "(indirect eval proxy)", this.meta)));
			}
		},
		3481: function (e, t, r) {
			...
			var n = r(1323),
				a = r(1472),
				s = r(94);
			let i = Symbol.for("scramjet original onevent function");
			function o(e, t) {
				let r = {
					message: {
						_init() {
					...
					hashchange: {
						oldURL() {
							return (0, a.v2)(this.oldURL);
						},
						newURL() {
							return (0, a.v2)(this.newURL);
						},
					},
					storage: {
						_init() {
					...
					return new Proxy(e, {
						apply(e, n, a) {
							...
							if (i.isTrusted) {
								...
								if (e in r) {
									let t = r[e];
									if (t._init && !1 === t._init.call(i)) return;
									a[0] = new Proxy(i, {
										get(e, r, n) {
											let a = Reflect.get(e, r);
											return r in t
												? t[r].call(e)
												: "function" == typeof a
													? new Proxy(a, {
				...
				(e.Proxy("EventTarget.prototype.addEventListener", {
					apply(t) {
						...
						let r = t.args[1],
							n = o(r);
						t.args[1] = n;
						let a = e.eventcallbacks.get(t.this);
						((a ||= []).push({
							event: t.args[0],
							originalCallback: r,
							proxiedCallback: n,
						}),
							e.eventcallbacks.set(t.this, a));
					},
				}),
					e.Proxy("EventTarget.prototype.removeEventListener", {
						apply(t) {
							...
							(e.eventcallbacks.set(t.this, r),
								(t.args[1] = a[0].proxiedCallback));
						},
					}));
				let l = [t.self, t.MessagePort.prototype];
				for (let a of (n.iswindow && l.push(t.HTMLElement.prototype),
				...
				l))
					for (let t of Reflect.ownKeys(a))
						if ("string" == typeof t && t.startsWith("on") && r[t.slice(2)]) {
							...
							e.RawTrap(a, t, {
								get(e) {
									return this[i] ? this[i] : e.get();
								},
								set(e, t) {
									if (((this[i] = t), "function" != typeof t)) return e.set(t);
									e.set(o(t));
								},
							});
						}
		...
		249: function (e, t, r) {
			...
			function a(e, t) {
				let r = e.call().toString(),
					a = (0, n.o)(`return ${r}`, "(function proxy)", t.meta);
				e.return(e.fn(a)());
			}
			function s(e, t) {
				let r = {
				...
				let n = e.natives.call("eval", null, "(function () {})").constructor,
					...
					i = e.natives.call("eval", null, "(function* () {})").constructor,
					o = e.natives.call(
						"eval",
						null,
						"(async function* () {})"
					...
					apply(t) {
						...
						t.return(
							(async () => {
								...
								return (
									Object.defineProperty(n, "name", { value: "", writable: !1 }),
									n
								);
							})()
						);
		...
		1914: function (e, t, r) {
			(r.r(t), r.d(t, { POLLUTANT: () => a, default: () => s }));
			var n = r(37);
			let a = Symbol.for("scramjet realm pollutant");
			function s(e, t) {
		...
		6972: function (e, t, r) {
			...
			function s(e) {
				(e.Proxy("fetch", {
					apply(t) {
						("string" == typeof t.args[0] || t.args[0] instanceof URL) &&
							((t.args[0] = (0, a.Oy)(t.args[0], e.meta)),
					...
					e.Trap("Response.prototype.url", { get: (e) => (0, a.v2)(e.get()) }),
					e.Trap("Request.prototype.url", { get: (e) => (0, a.v2)(e.get()) }));
			}
		},
		9931: function (e, t, r) {
			function n(e, t) {
				...
				(e.Proxy("WebSocket", {
					construct(n) {
						...
						(Object.setPrototypeOf(a, n.fn.prototype), (a.constructor = n.fn));
		...
		248: function (e, t, r) {
			...
			function s(e, t) {
				...
				let s = Symbol("xhr original args"),
					i = Symbol("xhr headers");
				(e.Proxy("XMLHttpRequest.prototype.open", {
					apply(t) {
						(t.args[1] && (t.args[1] = (0, a.Oy)(t.args[1], e.meta)),
					...
					e.Proxy("XMLHttpRequest.prototype.setRequestHeader", {
						apply(e) {
							(e.this[i] || (e.this[i] = {}))[e.args[0]] = e.args[1];
						},
					}),
					e.Proxy("XMLHttpRequest.prototype.send", {
						apply(t) {
							...
							let u = l.getUint16(1),
								d = l.getUint32(3),
								p = new Uint8Array(d);
							p.set(new Uint8Array(o.slice(7, 7 + d)));
					...
					value: (t, r) => {
						...
						(!(function (e, t, r) {
							let n = Uint8Array.from(t),
								...
								l = 4;
							for (let e = 0; e < o; e++) {
								let e = a.getUint32(l, !0);
								l += 4;
								let t = a.getUint32(l, !0);
								l += 4;
								let r = a.getUint8(l);
								if (((l += 1), 0 == r)) i.push({ type: r, start: e, size: t });
								else if (1 == r) {
									let o = e + t,
										c = a.getUint32(l, !0);
									l += 4;
									let u = s.decode(n.subarray(l, l + c));
									i.push({ type: r, start: e, end: o, str: u });
								}
							}
							e.box.sourcemaps[r] = i;
						})(e, t, r),
							a.time(e.meta, n, `scramtag parse for ${r}`));
					},
					enumerable: !1,
					writable: !1,
					configurable: !1,
						...
						apply(t) {
							(performance.now(),
								(function (e, t) {
									...
									if (!u)
										return (
											console.warn("failed to get rewrites for tag", a),
											t.return(r)
										);
									let d = 0;
									for (; d < u.length; )
		...
		9399: function (e, t, r) {
			...
			function s(e, t) {
				(e.Proxy("Worker", {
					construct(t) {
						((t.args[0] = (0, a.Oy)(t.args[0], e.meta) + "?dest=worker"),
							t.args[1] &&
					...
					e.Proxy("SharedWorker", {
						construct(t) {
							((t.args[0] =
								(0, a.Oy)(t.args[0], e.meta) + "?dest=sharedworker"),
								t.args[1] &&
					...
					e.Proxy("Worklet.prototype.addModule", {
						apply(t) {
							t.args[0] &&
								(t.args[0] = (0, a.Oy)(t.args[0], e.meta) + "?dest=worklet");
						},
					}));
			}
		},
		581: function (e, t, r) {
			...
			function o(e, t) {
				return function (r, s) {
					...
					if (r === t.eval) return i.indirectEval.bind(e, s);
					if (n.iswindow) {
						if (r === t.parent)
							if (a.pX in t.parent) return t.parent;
							else return t;
						else if (r === t.top) {
							let e = t;
							for (;;) {
								let t = e.parent.self;
								if (t === e || !(a.pX in t)) break;
								e = t;
							}
							return e;
						}
				...
				(Object.defineProperty(t, s.$W.globals.wrapfn, {
					...
					Object.defineProperty(t, s.$W.globals.trysetfn, {
						value: function (r, n, a) {
							return (
								r instanceof t.Location && ((e.locationProxy.href = a), !0)
							);
						},
						writable: !1,
						configurable: !1,
		...
		8409: function (e, t, r) {
			...
			function i(e, t) {
				...
				if ("fetch" === s) {
					a.log("ee", t);
					let s = o.filter((e) => "fetch" === e.event);
					if (!s) return;
					for (let o of s) {
						...
						Object.defineProperty(l, "destination", { value: s.destinitation });
						...
						((c.respondWith = (e) => {
							((u = !0),
								(async () => {
									...
									(a.log("sw", "responding", t), r.postMessage(t, [e.body]));
								})());
						}),
							a.log("to fn", c),
							o.proxiedCallback(
		...
		9052: function (e, t, r) {
			(r.r(t),
				r.d(t, { ScramjetController: () => a.q, ScramjetFrame: () => n.X }));
			var n = r(4869),
				a = r(3402);
		},
		8083: function (e, t, r) {
			...
			let n = {
				...
				a = {
					fmt: function (e, t, ...r) {
						...
						((Error.prepareStackTrace = n), this.print(e, a, t, ...r));
					},
					print(e, t, r, ...a) {
						(n[e] || n.log)(
							`%c${t}%c ${r}`,
  ...
  `,
		...
		3831: function (e, t, r) {
			...
			class s {
				...
				getCookies(e, t) {
					...
					return a.map((e) => `${e.name}=${e.value}`).join("; ");
				}
				load(e) {
		...
		37: function (e, t, r) {
			...
			let d = Function;
			function p() {
				((n = d(`return ${s.codec.encode}`)()),
					(a = d(`return ${s.codec.decode}`)()));
			}
			function h(e, t) {
				let r = s.flags[e];
		...
		2614: function (e, t, r) {
			...
			var n = r(1472);
			function a(e, t) {
				return i("rewrite", e, t);
			}
			function s(e) {
				return i("unrewrite", e);
			}
			function i(e, t, r) {
				return (t = (t = new String(t).toString()).replace(
					...
					(t, a) => {
						let s =
							"rewrite" === e ? (0, n.Oy)(a.trim(), r) : (0, n.v2)(a.trim());
		...
		4435: function (e, t, r) {
			...
			let s = new Set([
				...
				i = new Set(["location", "content-location", "referer"]);
			function o(e, t) {
			...
			async function l(e, t, r, l) {
				...
				for (let e of i) c[e] && (c[e] = (0, n.Oy)(c[e]?.toString(), t));
				if (
	...
	`,
				...
				return [
					t(c.$W.files.wasm),
					t(c.$W.files.all),
					t("data:application/javascript;base64," + a),
				];
			}
				...
				let g = performance.now(),
					m = (function (e, t, r, c = !1) {
						...
						if (
									...
									for (let e of u.V)
										for (let a in e) {
											...
											if (
												...
												let s = t.attribs[a],
													i = e.fn(s, n, r);
												(null === i ? delete t.attribs[a] : (t.attribs[a] = i),
													(t.attribs[`scramjet-attr-${a}`] = s));
											}
										}
							...
							(e ||
								((e = new a.Hg("head", {}, [])), d.root.children.unshift(e)),
								e.children.unshift(
									...p(t, (e) => new a.Hg("script", { src: e }))
								));
						}
						return (0, s.A)(d.root, {
							encodeEntities: "utf8",
		...
		1478: function (e, t, r) {
			...
			function i(e, t, r, n = !1) {
				return (function (e, t, r, n) {
					...
					try {
						...
						((o =
							"string" == typeof e
								? i.rewrite_js(e, r.base.href, t || "(unknown)", n)
								: i.rewrite_js_bytes(e, r.base.href, t || "(unknown)", n)),
							s.time(r, l, `oxc rewrite for "${t || "(unknown)"}"`));
						let { js: c, map: u, scramtag: d, errors: p } = o;
						return {
							js: "string" == typeof e ? a.su.decode(c) : c,
							tag: d,
							map: u,
							errors: p,
						};
			...
			function o(e, t, r, s = !1) {
				try {
					let a = i(e, t, r, s),
						o = a.js;
					if ((0, n.U5)("sourcemaps", r.base)) {
						let e = globalThis[n.$W.globals.pushsourcemapfn];
						if (e) e(Array.from(a.map), a.tag);
						else {
							o instanceof Uint8Array && (o = new TextDecoder().decode(o));
							let e = `${n.$W.globals.pushsourcemapfn}([${a.map.join(",")}], "${a.tag}");`,
								t = /^\s*(['"])use strict\1;?/;
							o = t.test(o)
								? o.replace(
										t,
...
${o}`;
					...
					if ((0, n.U5)("rewriterLogs", r.base))
						for (let e of a.errors) console.error("oxc parse error", e);
					return o;
				} catch (s) {
					if (
						(console.warn(
							...
							t || "(unknown)",
							s.message,
							e instanceof Uint8Array ? a.su.decode(e) : e
						),
		...
		1472: function (e, t, r) {
			...
			function l(e, t) {
				if (
					...
					return "javascript:" + (0, a.o)(e.slice(11), "(javascript: url)", t);
				{
			...
			function c(e) {
				...
				if (e.startsWith("javascript:")) return e;
				{
					...
					let r = s(e);
					if (!r) return e;
					let a = (0, n.P_)(r.hash.slice(1));
					return (
						(r.hash = ""),
						(0, n.P_)(r.href.slice(t.length) + (a ? "#" + a : ""))
					);
				}
			}
		},
		...
		2015: function (e, t, r) {
			...
			function s(e, t, r, s) {
				let i = "",
					...
					l = (e) => {
						o
							? (i += `import "${n.$W.files[e]}"
`)
							: (i += `importScripts("${n.$W.files[e]}");
`);
					};
				(l("wasm"),
					l("all"),
					(i += `$scramjetLoadClient().loadAndHook(${JSON.stringify(n.$W)});`));
				let c = (0, a.o)(e, r, s, o);
				return (
		...
		6684: function (e, t, r) {
			...
			var n = r(6570);
			let a = { none: 0, "same-origin": 1, "same-site": 2, "cross-site": 3 };
			async function s() {
			...
			async function h() {
				let e = Date.now(),
					t = (await s()).transaction("redirectTrackers", "readwrite");
				for await (let r of t.store)
					e - r.value.chainStarted > 36e5 && r.delete();
				await t.done;
			}
		...
		8228: function (e, t, r) {
			r.d(t, { Pg: () => d, eI: () => c, ps: () => l });
			var n = r(6570);
			let a = "publicSuffixList";
			async function s() {
				return (0, n.P2)("$scramjet", 1);
			}
			async function i() {
				let e = await s();
				return (await e.get("publicSuffixList", a)) || null;
			}
			async function o(e) {
				let t = await s();
				await t.put(
			...
			async function u(e, t) {
				...
				for (let e of r) {
					...
					if (
						...
						!s && t.length > a.length && (a = t);
					}
				}
				if (!a) return n.slice(-2).join(".");
		...
		1403: function (e, t, r) {
			...
			class n {
				...
				async fetch(e) {
					...
					let { scramjet$response: a } = await new Promise((e) => {
						this.promises[t] = e;
					});
					return (
						!!a &&
...
self.WASM = '${r}';`),
					...
					let p = new URL((0, i.v2)(o));
					for (let [e, t] of Object.entries(d)) p.searchParams.set(e, t);
					let h = { origin: p, base: p, topFrameName: r, parentFrameName: n };
					if (
						...
						r.startsWith("blob:") && (r = (0, i.$n)(r));
						let n = await fetch(r, {});
						((n.finalURL = r.startsWith("blob:") ? r : "(data url)"),
							n.body &&
								(t = await b(n, h, e.destination, u, this.cookieStore)));
						let a = Object.fromEntries(n.headers.entries());
						return (
							crossOriginIsolated &&
					...
					if (p.origin === new URL(e.url).origin)
						throw Error(
					...
					if (
						...
						let t = (0, i.v2)(e.referrer);
						if (t) {
							let e = new URL(t);
							v = await (0, a.ps)(h, e, this.client);
						}
					}
					(await (0, s.rj)(
						p.toString(),
						e.referrer ? (0, i.v2)(e.referrer) : null,
						v
					),
						m.set("Sec-Fetch-Site", await (0, s.hU)(p.toString(), v)));
					let k = new S(p, m.headers, e.body, e.method, e.destination, t);
					this.dispatchEvent(k);
					let E =
						(await k.response) ||
						(await this.client.fetch(k.url, {
							method: k.method,
							body: k.body,
							headers: k.requestHeaders,
							credentials: "omit",
					...
					let r = Object.entries(t)
						...
						.join("\n\n");
					return (0, n.v)(r, (0, i.v2)(e.url));
				}
			}
			async function y(e, t, r, n, o, l, d, p, h, f, m) {
				let y,
					S = "navigate" === o && ["document", "iframe"].includes(n),
					x = await (0, u.l)(l.rawHeaders, t, h, { get: s.Yq, set: s.pL });
				if (
					(S &&
						x["referrer-policy"] &&
						m &&
					...
					let t = new URL((0, i.v2)(x.location));
					await (0, s.YH)(e.toString(), t.toString(), x["referrer-policy"]);
					let n = await (0, a.ps)({ origin: t, base: t }, e, h);
				...
				for (let t in (await d.setCookies(v instanceof Array ? v : [v], e), x))
				...
				if (
					...
					if ((0, c.U5)("interceptDownloads", e)) {
						...
						let n = x["content-length"],
							a = await clients.matchAll({});
						if ((a = a.filter((e) => !e.url.includes(c.$W.prefix))).length < 1)
							throw Error(
						...
						(a[0].postMessage({ scramjet$type: "download", download: s }, [
							l.body,
						]),
							await new Promise(() => {}));
					} else {
						...
						if (!/\s*?((inline|attachment);\s*?)filename=/i.test(e)) {
							...
							x["content-disposition"] = `${t}; filename=${JSON.stringify(r)}`;
						}
					}
				...
				let k = new w(y, x, l.status, l.statusText, n, e, l, p);
				return (
					f.dispatchEvent(k),
					g(l) || (await (0, s.Sn)(e.toString())),
					new Response(k.responseBody, {
				...
				switch (r) {
					...
					case "document":
						if (e.headers.get("content-type")?.startsWith("text/html"))
							return (0, d.Qs)(await e.text(), a, t, !0);
						return e.body;
					case "script":
						return (0, o.o)(
		...
		7510: function (e, t, r) {
			(r.r(t),
				r.d(t, {
					...
					ScramjetHandleResponseEvent: () => a.dT,
					ScramjetRequestEvent: () => a.V3,
			...
			class d extends EventTarget {
				...
				async loadConfig() {
					...
					((this.config = await e.get("config", "config")),
						this.config && ((0, c.Nk)(this.config), await (0, i.n$)()));
				}
				route({ request: e }) {
					return (
		...
		236: function (e, t, r) {
			...
			class h {
				...
				async sendMessage(e, t) {
					...
					return (o.call(this.port, { message: e, port: r.port2 }, n), await a);
				}
			}
									...
									await (async function (e, t, r) {
										...
										((e.websocket.channel.onmessage = (e) => {
											"data" === e.data.type
												? n(e.data.data)
												: "close" === e.data.type &&
													a(e.data.closeCode, e.data.closeReason);
										}),
			...
			class S {
				...
				async fetch(e, t) {
					let r = new Request(e, t),
						...
						s = a instanceof Headers ? Object.fromEntries(a) : a,
						i = r.body,
						o = new URL(r.url);
					...
					for (let e = 0; ; e++) {
						let n = (
							...
							a = new Response(y.includes(n.status) ? void 0 : n.body, {
								headers: new Headers(n.headers),
								status: n.status,
								statusText: n.statusText,
							});
						((a.rawHeaders = n.headers),
							(a.rawResponse = n),
							(a.finalURL = o.toString()));
						let l = t?.redirect || r.redirect;
						if (!b.includes(a.status)) return a;
						switch (l) {
							case "follow": {
						...
						p += (function (t, r) {
							...
							switch (t.type) {
								...
								case n.Mw:
									return ((p = t), `<!--${p.data}-->`);
								case n.KB:
									return ((h = t), `<![CDATA[${h.children[0].data}]]>`);
								case n.eF:
								case n.OF:
								case n.vw:
									return (function (t, r) {
										...
										return (
											...
											(r.xmlMode
												...
												? (r.xmlMode || (i += " "), (i += "/>"))
												: ((i += ">"),
													t.children.length > 0 && (i += e(t.children, r)),
									...
									return (function (e, t) {
										...
										return (
											(null != (r = t.encodeEntities)
												? r
												: t.decodeEntities) === !1 ||
												(!t.xmlMode && e.parent && i.has(e.parent.name)) ||
												(n =
													t.xmlMode || "utf8" !== t.encodeEntities
														? (0, a.WY)(n)
														: (0, a.X1)(n)),
		...
		6072: function (e, t, r) {
			...
			function h(e, t = !1) {
				let r;
				if (e.type === n.RJ.Text) r = new i(e.data);
		...
		6812: function (e, t, r) {
			var n, a;
			(r(8866),
				((a = n || (n = {}))[(a.DISCONNECTED = 1)] = "DISCONNECTED"),
			...
			class g {
				...
				addToNumericResult(e, t, r, n) {
					if (t !== r) {
						let a = r - t;
						((this.result =
							this.result * Math.pow(n, a) +
							Number.parseInt(e.substr(t, a), n)),
							(this.consumed += a));
					}
				}
				stateNumericHex(e, t) {
				...
				emitNumericEntity(e, t) {
					...
					return (
						this.emitCodePoint((0, h.y6)(this.result), this.consumed),
						this.errors &&
							(e !== o.SEMI &&
					...
					for (; t < e.length; t++, this.excess++) {
						...
						if (
							((this.treeIndex = (function (e, t, r, n) {
								...
								return -1;
							})(r, n, this.treeIndex + Math.max(1, a), s)),
							this.treeIndex < 0)
						)
						...
						if (0 != (a = ((n = r[this.treeIndex]) & l.VALUE_LENGTH) >> 14)) {
							if (s === o.SEMI)
			...
			function i(e) {
				...
				for (; null !== (t = n.exec(e)); ) {
					let { index: o } = t,
						...
						c = a.get(l);
					void 0 === c
						? ((r += `${e.substring(i, o)}&#x${s(e, o).toString(16)};`),
							(i = n.lastIndex += Number((64512 & l) == 55296)))
						: ((r += e.substring(i, o) + c), (i = o + 1));
				}
				return r + e.substr(i);
			}
			function o(e, t) {
				return function (r) {
					let n,
						...
						s = "";
					for (; (n = e.exec(r)); )
						(a !== n.index && (s += r.substring(a, n.index)),
							(s += t.get(n[0].charCodeAt(0))),
							(a = n.index + 1));
					return s + r.substring(a);
				};
			}
			let l = o(
					/["&\u00A0]/g,
		...
		4645: function (e, t, r) {
			...
			class g {
				constructor(e, t = {}) {
					...
					((this.options = t),
						...
						(this.lowerCaseAttributeNames =
							null != (a = t.lowerCaseAttributeNames) ? a : this.htmlMode),
						(this.recognizeSelfClosing =
							null != (s = t.recognizeSelfClosing) ? s : !this.htmlMode),
						(this.tokenizer = new (null != (i = t.Tokenizer) ? i : n.A)(
							this.options,
							this
						)),
				...
				ontext(e, t) {
					...
					((this.endIndex = t - 1),
						null == (n = (r = this.cbs).ontext) || n.call(r, a),
						(this.startIndex = t));
				}
				ontextentity(e, t) {
					var r, n;
					((this.endIndex = t - 1),
						null == (n = (r = this.cbs).ontext) || n.call(r, (0, a.MK)(e)),
						(this.startIndex = t));
				}
				isVoidElement(e) {
					...
					(!this.isVoidElement(e) &&
						...
						this.htmlMode &&
							(p.has(e)
								...
								: h.has(e) && this.foreignContext.unshift(!1))),
				...
				onclosetag(e, t) {
					...
					if (
						...
						this.htmlMode &&
							"br" === u &&
							(null == (s = (a = this.cbs).onopentagname) || s.call(a, "br"),
							null == (o = (i = this.cbs).onopentag) || o.call(i, "br", {}, !0),
				...
				onattribentity(e) {
					this.attribvalue += (0, a.MK)(e);
				}
				onattribend(e, t) {
					var r, a;
					((this.endIndex = t),
						null == (a = (r = this.cbs).onattribute) ||
							a.call(
								r,
								this.attribname,
								this.attribvalue,
				...
				oncomment(e, t, r) {
					var n, a, s, i;
					((this.endIndex = t),
						null == (a = (n = this.cbs).oncomment) ||
							a.call(n, this.getSlice(e, t - r)),
						null == (i = (s = this.cbs).oncommentend) || i.call(s),
						(this.startIndex = t + 1));
				}
				oncdata(e, t, r) {
					var n, a, s, i, o, l, c, u, d, p;
					this.endIndex = t;
					let h = this.getSlice(e, t - r);
					(!this.htmlMode || this.options.recognizeCDATA
						? (null == (a = (n = this.cbs).oncdatastart) || a.call(n),
							null == (i = (s = this.cbs).ontext) || i.call(s, h),
							null == (l = (o = this.cbs).oncdataend) || l.call(o))
						: (null == (u = (c = this.cbs).oncomment) ||
								u.call(c, `[CDATA[${h}]]`),
							null == (p = (d = this.cbs).oncommentend) || p.call(d)),
						(this.startIndex = t + 1));
				}
				onend() {
					var e, t;
					...
					e === t || (!this.decodeEntities && this.fastForwardTo(t))
						? (this.cbs.onattribdata(this.sectionStart, this.index),
							...
							this.cbs.onattribend(
								t === i.DoubleQuote ? l.Double : l.Single,
								this.index + 1
							),
							(this.state = o.BeforeAttributeName))
						: this.decodeEntities && e === i.Amp && this.startEntity();
		...
		6570: function (e, t, r) {
				...
				return (
					n &&
						i.addEventListener("upgradeneeded", (e) => {
							n(p(i.result), e.oldVersion, e.newVersion, p(i.transaction), e);
						}),
					r &&
			...
			function b(e, t) {
				...
				let s = async function (e, ...t) {
					let s = this.transaction(e, a ? "readwrite" : "readonly"),
						i = s.store;
					return (
						n && (i = i.index(t.shift())),
			...
			async function* E(...e) {
				...
				if ((t instanceof IDBCursor || (t = await t.openCursor(...e)), !t))
					return;
				let r = new Proxy(t, k);
				for (v.set(r, t), u.set(r, h(t)); t; )
					(yield r, (t = await (x.get(r) || t.continue())), x.delete(r));
			}
			function T(e, t) {
				return (
			...
			d = {
				...(i = d),
				get: (e, t, r) => (T(e, t) ? E : i.get(e, t, r)),
				has: (e, t) => T(e, t) || i.has(e, t),
			};
		},
		3907: function (e, t, r) {
			function n(e) {
...
(l.d(c, {
	...
	Qs: () => r.Qs,
	Sn: () => r.Sn,
	Tu: () => e.ScramjetServiceWorkerRuntime,
	U5: () => r.U5,
	Uk: () => r.Uk,
	V0: () => e.iswindow,
	V3: () => n.ScramjetRequestEvent,
	VP: () => r.VP,
	Vc: () => e.ScramjetGlobalDownloadEvent,
	Vj: () => e.isworker,
	XD: () => t.ScramjetFrame,
	YH: () => r.YH,
	Yq: () => r.Yq,
	Z5: () => e.getOwnPropertyDescriptorHandler,
	Zp: () => e.issw,
	_0: () => s._0,
	aR: () => a.aR,
	bw: () => e.ScramjetClient,
	cN: () => e.isemulatedsw,
	ch: () => e.isshared,
	dT: () => n.ScramjetHandleResponseEvent,
	eI: () => r.eI,
	f9: () => r.f9,
	gP: () => r.gP,
	hD: () => r.hD,
	hU: () => r.hU,
	iP: () => r.iP,
	jV: () => n.ScramjetServiceWorker,
	kg: () => e.createLocationProxy,
	kv: () => r.kv,
	lB: () => r.lB,
	n$: () => r.n$,
	nK: () => r.nK,
	...
	ps: () => r.ps,
	q9: () => a.q9,
	qi: () => t.ScramjetController,
	qp: () => r.qp,
	rj: () => r.rj,
	rx: () => e.ScramjetContextEvent,
	sM: () => r.sM,
	su: () => r.su,
	uh: () => r.uh,
	v2: () => r.v2,
...
var u = c.HT,
	...
	ev = c.YH;
export {
	u as $scramjetLoadClient,
	d as $scramjetLoadController,
	p as $scramjetLoadWorker,
	h as $scramjetVersion,
	f as CookieStore,
	g as FakeServiceWorker,
	m as NavigateEvent,
	y as SCRAMJETCLIENT,
	b as SCRAMJETCLIENTNAME,
	w as SCRAMJETFRAME,
	S as ScramjetClient,
	x as ScramjetContextEvent,
	v as ScramjetController,
	k as ScramjetFrame,
	E as ScramjetGlobalDownloadEvent,
	T as ScramjetHandleResponseEvent,
	C as ScramjetHeaders,
	A as ScramjetRequestEvent,
	_ as ScramjetServiceWorker,
	P as ScramjetServiceWorkerRuntime,
	L as UrlChangeEvent,
	I as asyncSetWasm,
	N as cleanExpiredTrackers,
	j as cleanTracker,
	R as codecDecode,
	O as codecEncode,
	$ as config,
	D as createLocationProxy,
	q as errorTemplate,
	W as flagEnabled,
	M as getInjectScripts,
	U as getMostRestrictiveSite,
	B as getOwnPropertyDescriptorHandler,
	H as getPublicSuffixList,
	F as getReferrerPolicy,
	V as getRewriter,
	G as getSiteDirective,
	X as handleFetch,
	J as htmlRules,
	z as initializeTracker,
	Q as isSameSite,
	Y as isdedicated,
	K as isemulatedsw,
	Z as isshared,
	...
	ei as rewriteBlob,
	eo as rewriteCss,
	el as rewriteHeaders,
	ec as rewriteHtml,
	eu as rewriteJs,
	ed as rewriteJsInner,
	ep as rewriteSrcset,
	eh as rewriteUrl,
	ef as rewriteWorkers,
	eg as setConfig,
	em as storeReferrerPolicy,
	ey as textDecoder,
	eb as unrewriteBlob,
	ew as unrewriteCss,
	eS as unrewriteHtml,
