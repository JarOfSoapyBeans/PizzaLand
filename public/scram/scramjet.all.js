(() => {
	var e = {
							...
							for (t = o, a = !1; l(); )
								if ("," === (r = e.charAt(o))) {
									...
									o < e.length && "=" === e.charAt(o)
										? ((a = !0), (o = s), i.push(e.substring(t, n)), (t = o))
										: (o = n + 1);
								} else o += 1;
				...
				class g {
					...
					RawProxy(e, t, r) {
						...
						(r.construct &&
							(a.construct = function (e, t, n) {
								let s,
									...
									i = {
										...
										call: () => (
											(a = !0),
											(s = Reflect.construct(i.fn, i.args, i.newTarget))
										),
									};
								return (r.construct(i), a)
									? s
								...
								(a.apply = (e, t, n) => {
									let s,
										...
										i = {
											...
											call: () => (
												(a = !0),
												(s = Reflect.apply(i.fn, i.this, i.args))
											),
										},
							...
							(a.getOwnPropertyDescriptor = s.getOwnPropertyDescriptorHandler),
							(e[t] = new Proxy(n, a)));
					}
					Trap(e, t) {
						if (Array.isArray(e)) {
						...
						return ((this.descriptors.store[e] = a), this.RawTrap(s, n, t));
					}
					RawTrap(e, t, r) {
						if (!e || !t || !Reflect.has(e, t)) return;
					...
					(e.Trap("Node.prototype.baseURI", {
						...
						e.Proxy("Element.prototype.setAttribute", {
							apply(t) {
								...
								if (a) {
									let n = a.fn(s, e.meta, e.cookieStore);
									if (null == n) {
										(e.natives.call(
						...
						["History.prototype.pushState", "History.prototype.replaceState"],
						{
							apply(t) {
								...
								if (i.name === e.meta.topFrameName) {
									let t = new s.UrlChangeEvent(o.url.href);
						...
						e.Proxy("ServiceWorkerContainer.prototype.register", {
							apply(t) {
								...
								(Object.setPrototypeOf(
									...
									(n.constructor = t.fn));
								let a = (0, s.Oy)(t.args[0], e.meta) + "?dest=serviceworker";
								t.args[1] &&
									"module" === t.args[1].type &&
									(a += "&type=module");
								let i = e.natives.construct("SharedWorker", a).port,
			...
			1323: function (e, t, r) {
				...
				function g(e) {
					if (
						...
						let s = new i.UrlChangeEvent(e.url.href);
			...
			3696: function (e, t, r) {
				...
				function i(e, t) {
					...
					for (let r of [
						...
						(s.get && (a.get = new Proxy(s.get, { apply: () => e.url[r] })),
							s.set &&
								(a.set = new Proxy(s.set, {
									apply(s, a, i) {
										if ("href" === r) {
											e.url = i[0];
											return;
			...
			582: function (e, t, r) {
				(r.r(t),
					r.d(t, { argdbg: () => a, default: () => i, enabled: () => s }));
				var n = r(37);
			...
			6143: function (e, t, r) {
				(r.r(t), r.d(t, { default: () => i, enabled: () => a }));
				var n = r(37),
					s = r(1472);
			...
			591: function (e, t, r) {
				(r.r(t), r.d(t, { default: () => a, indirectEval: () => i }));
				var n = r(37),
					s = r(1478);
				function a(e, t) {
		...
		`)))
			...
			1914: function (e, t, r) {
				(r.r(t), r.d(t, { POLLUTANT: () => s, default: () => a }));
				var n = r(37);
				...
				function n(e, t) {
					...
					(e.Proxy("WebSocket", {
						construct(n) {
							...
							(Object.setPrototypeOf(s, n.fn.prototype),
								(s.constructor = n.fn));
			...
			581: function (e, t, r) {
				...
				function o(e, t) {
					return function (r, a) {
						...
						if (r === t.eval) return i.indirectEval.bind(e, a);
						if (n.iswindow) {
							if (r === t.parent)
  ...
  `,
			...
			37: function (e, t, r) {
				...
				let i = Function;
				function o() {
					((n = i(`return ${a.codec.encode}`)()),
						(s = i(`return ${a.codec.decode}`)()));
				}
				function l(e, t) {
					let r = a.flags[e];
				...
				function i(e, t, r, o = !1) {
					try {
						...
						if ((0, n.U5)("sourcemaps", r.base)) {
							...
							if (e) e(Array.from(i.map), i.tag);
							else {
								l instanceof Uint8Array && (l = new TextDecoder().decode(l));
								let e = `${n.$W.globals.pushsourcemapfn}([${i.map.join(",")}], "${i.tag}");`,
									t = /^\s*(['"])use strict\1;?/;
								l = t.test(l)
									? l.replace(
											t,
...
${l}`;
						...
						if ((0, n.U5)("rewriterLogs", r.base))
							for (let e of i.errors) console.error("oxc parse error", e);
						return l;
					} catch (a) {
						if (
							(console.warn(
...
`);
			...
			6684: function (e, t, r) {
				...
				var n = r(6570);
				let s = { none: 0, "same-origin": 1, "same-site": 2, "cross-site": 3 };
				async function a() {
			...
			8228: function (e, t, r) {
				r.d(t, { ps: () => l });
				var n = r(6570);
				let s = "publicSuffixList";
				async function a() {
					return (0, n.P2)("$scramjet", 1);
				}
				async function i() {
					let e = await a();
					return (await e.get("publicSuffixList", s)) || null;
				}
				async function o(e) {
					let t = await a();
					await t.put(
				...
				async function u(e, t) {
					...
					for (let e of r) {
						...
						if (
							...
							!a && t.length > s.length && (s = t);
						}
					}
					if (!s) return n.slice(-2).join(".");
					let i = s.split(".").length,
						o = a ? i : i + 1;
...
self.WASM = '${r}';`),
						...
						if (
							...
							if (t) {
								let e = new URL(t);
								x = await (0, s.ps)(p, e, this.client);
							}
						}
						(await (0, a.rj)(
							h.toString(),
				...
				async function y(e, t, r, n, o, l, d, h, p, f, m) {
					...
					if (
						...
						let t = new URL((0, i.v2)(v.location));
					...
					if (
						...
						if ((0, c.U5)("interceptDownloads", e)) {
							...
							(s[0].postMessage({ scramjet$type: "download", download: a }, [
								l.body,
							]),
								await new Promise(() => {}));
						} else {
		...
		`,
						...
						for (; t < e.length; t++, this.excess++) {
							...
							if (
								((this.treeIndex = (function (e, t, r, n) {
									...
									return -1;
								})(r, n, this.treeIndex + Math.max(1, s), a)),
								this.treeIndex < 0)
							)
				...
				function i(e) {
					...
					for (; null !== (t = n.exec(e)); ) {
						let { index: o } = t,
							...
							c = s.get(l);
						void 0 === c
							? ((r += `${e.substring(i, o)}&#x${a(e, o).toString(16)};`),
				...
				class g {
					...
					onclosetag(e, t) {
						...
						if (
							...
							this.htmlMode &&
								"br" === u &&
								(null == (a = (s = this.cbs).onopentagname) || a.call(s, "br"),
			...
			6570: function (e, t, r) {
				...
				function f(
					e,
					t,
					{ blocked: r, upgrade: n, blocking: s, terminated: a } = {}
				) {
					...
					return (
						n &&
							i.addEventListener("upgradeneeded", (e) => {
								n(h(i.result), e.oldVersion, e.newVersion, h(i.transaction), e);
							}),
						r &&
				...
				function b(e, t) {
					...
					let a = async function (e, ...t) {
						...
						return (
							n && (i = i.index(t.shift())),
							(await Promise.all([i[r](...t), s && a.done]))[0]
						);
					};
					return (y.set(t, a), a);
				}
